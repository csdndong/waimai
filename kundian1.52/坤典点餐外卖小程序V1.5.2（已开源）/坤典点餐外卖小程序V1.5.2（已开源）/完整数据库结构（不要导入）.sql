...
Date: 2019-05-23 00:45:21
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for ims_cqkundian_ordering_about
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_about`;
CREATE TABLE `ims_cqkundian_ordering_about` (
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_address
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_address`;
CREATE TABLE `ims_cqkundian_ordering_address` (
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_batch
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_batch`;
CREATE TABLE `ims_cqkundian_ordering_batch` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_cancel_person
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_cancel_person`;
CREATE TABLE `ims_cqkundian_ordering_cancel_person` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_cancel_record
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_cancel_record`;
CREATE TABLE `ims_cqkundian_ordering_cancel_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_cart
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_cart`;
CREATE TABLE `ims_cqkundian_ordering_cart` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_customer
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_customer`;
CREATE TABLE `ims_cqkundian_ordering_customer` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_desk
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_desk`;
CREATE TABLE `ims_cqkundian_ordering_desk` (
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_desk_order
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_desk_order`;
CREATE TABLE `ims_cqkundian_ordering_desk_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_desk_order_detail
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_desk_order_detail`;
CREATE TABLE `ims_cqkundian_ordering_desk_order_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_exchange
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_exchange`;
CREATE TABLE `ims_cqkundian_ordering_exchange` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `pid` int(11) NOT NULL COMMENT '商品id',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_giftlevel
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_giftlevel`;
CREATE TABLE `ims_cqkundian_ordering_giftlevel` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_goods
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_goods`;
CREATE TABLE `ims_cqkundian_ordering_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_goods_type
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_goods_type`;
CREATE TABLE `ims_cqkundian_ordering_goods_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_make_order
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_make_order`;
CREATE TABLE `ims_cqkundian_ordering_make_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `uid` int(11) NOT NULL COMMENT '用户id',
  `uniacid` int(11) NOT NULL COMMENT '小程序id',
  `create_time` int(11) NOT NULL COMMENT '创建时间',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_make_order_detail
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_make_order_detail`;
CREATE TABLE `ims_cqkundian_ordering_make_order_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_msg_config
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_msg_config`;
CREATE TABLE `ims_cqkundian_ordering_msg_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `uniacid` int(11) NOT NULL COMMENT '小程序id',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_nav
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_nav`;
CREATE TABLE `ims_cqkundian_ordering_nav` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_order
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_order`;
CREATE TABLE `ims_cqkundian_ordering_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `order_number` char(50) NOT NULL COMMENT '订单编号',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_order_detail
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_order_detail`;
CREATE TABLE `ims_cqkundian_ordering_order_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_print
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_print`;
CREATE TABLE `ims_cqkundian_ordering_print` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_product
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_product`;
CREATE TABLE `ims_cqkundian_ordering_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_product_type
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_product_type`;
CREATE TABLE `ims_cqkundian_ordering_product_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `type_name` char(50) NOT NULL COMMENT '分类名称',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_sale
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_sale`;
CREATE TABLE `ims_cqkundian_ordering_sale` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_slide
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_slide`;
CREATE TABLE `ims_cqkundian_ordering_slide` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `title` char(100) NOT NULL COMMENT '标题',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_token
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_token`;
CREATE TABLE `ims_cqkundian_ordering_token` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
...
-- ----------------------------
-- Table structure for ims_cqkundian_ordering_user
-- ----------------------------
DROP TABLE IF EXISTS `ims_cqkundian_ordering_user`;
CREATE TABLE `ims_cqkundian_ordering_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
