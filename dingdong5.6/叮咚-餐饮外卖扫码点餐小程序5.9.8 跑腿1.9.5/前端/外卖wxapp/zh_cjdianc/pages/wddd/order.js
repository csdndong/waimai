...
Page(_defineProperty({
    ...
    onLoad: function(t) {
        ...
        console.log(getApp().xtxx1), getApp().xtxx1 && app.pageOnLoad(a), app.util.request({
            ...
            success: function(t) {
                ...
                null == getApp().xtxx1 && (getApp().xtxx1 = e, app.pageOnLoad(a)), "" == t.data.dc_name && (t.data.dc_name = "店内"), 
                "" == t.data.wm_name && (t.data.wm_name = "外卖"), a.setData({
                    System: t.data
                });
            }
        });
    ...
    reLoad: function() {
        ...
        t = "2"), "5" == e && (e = "6,7,8,9,10", t = "3"), console.log(e, t, o, n), app.util.request({
