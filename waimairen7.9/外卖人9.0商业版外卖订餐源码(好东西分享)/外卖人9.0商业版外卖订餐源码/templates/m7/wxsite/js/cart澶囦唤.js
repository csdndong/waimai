	...
	if( payway == 2){
	 ...
	 if(checknext ==  false){ 
        ...
        $.ajax({         //script定义
                 ...
                 dataType: "json",
                 async:true,
                 data:{shopid:shopid,'remark':remark,'minit':$("#DeliveryTime").val(),'is_hand':is_hand,'dikou':jfcost,'juanid':$('#juanid').val(),'paytype':payway,'buyerlng':buyerlng,'buyerlat':buyerlat},
