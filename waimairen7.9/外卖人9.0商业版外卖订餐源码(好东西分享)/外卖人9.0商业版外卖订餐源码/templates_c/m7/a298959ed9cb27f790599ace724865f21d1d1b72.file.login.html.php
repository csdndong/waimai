<?php /* Smarty version Smarty-3.1.10, created on 2019-05-10 19:28:03
         compiled from "D:\wwwroot\demo.52jscn.com\templates\m7\member\login.html" */ ?>
<?php /*%%SmartyHeaderCode:148495cd56043833f32-41819162%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a298959ed9cb27f790599ace724865f21d1d1b72' => 
    array (
      0 => 'D:\\wwwroot\\demo.52jscn.com\\templates\\m7\\member\\login.html',
      1 => 1536024583,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '148495cd56043833f32-41819162',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cd56043b86e06_04187113',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cd56043b86e06_04187113')) {function content_5cd56043b86e06_04187113($_smarty_tpl) {?><?php if (!is_callable('smarty_function_load_data')) include 'D:\\wwwroot\\demo.52jscn.com\\lib\\Smarty\\libs\\plugins\\function.load_data.php';
...
<div style="clear:both;"></div>
 ...
 <div class="SigninCon">
     <div class="SigninBox">
         <div class="Signin">
             <div class="SigninLeft"><img src="<?php echo $_smarty_tpl->tpl_vars['siteurl']->value;?>
/templates/<?php echo $_smarty_tpl->tpl_vars['tempdir']->value;?>
/public/img/Signin_left.png"></div>
...
">
                     <div class="SigninRtit"><h3>用户登录</h3><span>没有账号？<a href="<?php echo FUNC_function(array('type'=>'url','link'=>"/member/regester"),$_smarty_tpl);?>
">免费注册</a></span></div>
                     <div class="SigninRinpBox">
                         ...
                         <div class="SigninRinp">
						  ...
						  <div class="SigninRinp">
                              <div style="float:left;" ><input style="width:80px;" name="Captcha" type="text"  class="inputOne"  placeholder="验证码" value=""/></div>
								<div style="float:left; width:90px; height:42px;" ><img style="margin-left:10px; width:90px; height:42px;" width="90" height="42" src="<?php echo FUNC_function(array('type'=>'url','link'=>"/site/getCaptcha"),$_smarty_tpl);?>
" id="captchaimg"></div>
								<div style="float:left;margin-left:4px;height:42px;line-height:42px;" ><a style="color:#000;" href="javascript:freshcode();" >刷新图片</a></div>
                         </div>
                     ...
                     <div class="SigninRchebox">
                         <div class="SigninRche">

                             <input name="LoginForm[rememberMe]" type="checkbox" checked="" value="1"/>
                         </div>
...
">忘记密码?</a>
                     ...
                     <div class="SigninRbut"><input type="button" id="login_in" value="登　录"></div>
                     <!-- <div class="SigninRthpalo">
                         <div class="SigninRthpaloTit">使用以下账户直接登录</div>
                         <div class="SigninRthpaloIco">
                             <ul id="type_login">
...
/plug/login/<?php echo $_smarty_tpl->tpl_vars['items']->value['loginname'];?>
/login.php" target="_blank">
                                        <i class="<?php if ($_smarty_tpl->tpl_vars['items']->value['loginname']=='wx'){?>icon_wx<?php }elseif($_smarty_tpl->tpl_vars['items']->value['loginname']=='sina'){?>icon_xl<?php }else{ ?>icon_qq<?php }?>"></i>
                                     </a>
                                 </li>
                                 <?php } ?>
                                 <?php }?>
