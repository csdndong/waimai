...
if( strpos($_SERVER["HTTP_USER_AGENT"],'MicroMessenger')    ){    //判断是微信浏览器不
	//  $html_text = '<style>body{margin:0px;padding:0px;}</style><img style="width:100%;height:100%;" src="/upload/images/wx_web_alimobile.png" id="mask" />';
	$linkurl = $alipaySubmit->wx_buildRequestForm($parameter, 'get', '确认');
}else{
