...
$incFile = fopen($logindir."/".$idtype."/lib/WxPay.Config.php","w+") or die("请设置plug\pay\weixinapp\lib\WxPay.Config.php的权限为777"); 
...
$setting .= "const SSLCERT_PATH = '/plug/pay/weixinapp/cert/apiclient_cert.pem';".PHP_EOL;
$setting .= "const SSLKEY_PATH = '/plug/pay/weixinapp/cert/apiclient_key.pem';".PHP_EOL;
