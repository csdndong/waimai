...
class method   extends adminbaseclass
{
	 ...
	 function  asklist(){
	  ...
	  // $checkinfo = $this->mysql->select_one("select * from ".Mysite::$app->config['tablepre']."ask as a  
	  // 	left join ".Mysite::$app->config['tablepre']."member as b on b.uid =a.uid 
	  // 	where a.typeid like'".$data['typeid']."' or  b.username ='".$searchvalue."'"); 
     
	  // $data['items'] =$checkinfo;
