...
Page((_defineProperty(_Page = {
    ...
    onLoad: function(t) {
        var c = this;
        if (0 != wx.getStorageSync("kundian_ordering_uid")) {
            app.util.request({
                ...
                success: function(t) {
                    ...
                    c.setData({
                        typeData: a,
                        aboutData: s,
                        currentIndex: t.data.goodsType[0].id,
                        shopImg: i,
                        loading: !1
                    });
                }
            }), app.globalData.windowHeight < 600 && (c.data.lessScrean = !0);
            c.setData({
    ...
    sumPrice: function(t) {
        ...
        var i = this.data.aboutData, c = 1, n = e.toFixed(2);
        c = parseFloat(i.begin_price) > parseFloat(n) ? 1 : 2, this.setData({
            totalPrice: n,
    ...
    changeSpec: function(t) {
        var e = this, a = t.currentTarget.dataset, s = a.itemid, i = a.valid, c = a.specItem, n = a.skuData, r = new Array();
        c.map(function(e) {
            e.specVal.map(function(t) {
                e.id == s && (t.select = !1), t.id == i && (t.select = !0), t.select && r.push(t.id);
            });
        });
    ...
    confrim: function(t) {
        var e = this, a = t.currentTarget.dataset, s = (a.id, a.proid, e.data), i = s.typeData, c = s.selectSpec, n = (s.selectList, 
        []);
        i.map(function(t) {
            t.items(function(t) {
                t.id == c[0].goods_id && (t.selectSpec = c, n.push(t));
            });
        }), e.setData({
