module.exports = {
    ...
    setSchedule: function(t) {
        ...
        new Date(a, e, 0).getDate()), n = t.data.currentObj.getUTCDay() + 1 - (r % 7 - 1), c = n <= 0 ? 7 + n : n, u = [], i = 0, o = {};
        o.y = a, o.m = e, e < 10 && (o.m = "0" + e);
        var s = [ "周一", "周二", "周三", "周四", "周五", "周六", "周日" ];
        if (1 == t.data.isdelay) {
        ...
        for (var f = t.data.maxday, v = t.data.initDate, p = t.data.checkedDate, k = 0; k < 42; k++) {
            ...
            if (k < c - 1) u[k] = {
                ...
                var Y = !1, j = !1, w = Date.parse(o.y + "/" + o.m + "/" + o.d);
    ...
    selectDay: function(t, e) {
        if (t.target.dataset.day) {
            ...
            }), console.log("当前选择日期：" + e.data.currentDate);
        }
    }
};