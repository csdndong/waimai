...
if ($op == "list") {
    ...
    if (!empty($keyword)) {
        $condition .= " AND (buy_username LIKE '%" . $keyword . "%' OR buy_mobile LIKE '%" . $keyword . "%' OR accept_username LIKE '%" . $keyword . "%' OR accept_mobile LIKE '%" . $keyword . "%' OR order_sn LIKE '%" . $keyword . "%' OR refund_out_no LIKE '%" . $keyword . "%')";
    }
