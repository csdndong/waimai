...
if ($op == "index") {
    $_W["page"]["title"] = "配送员统计";
    $condition = " as a left join " . tablename("tiny_wmall_order_comment") . " as b on a.id = b.oid where a.uniacid = :uniacid and a.agentid = :agentid and a.status = 5 and a.delivery_type = 2 and a.order_type <= 2";
