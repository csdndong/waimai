	...
	diy.getParts = function(){
		diy.parts = {
			img_card: {
				name: '图片标题',
				params: {
					imgurl: '../addons/we7_wmall/plugin/iservice/static/img/default/img-card-1.jpg',
				},
			...
			banner: {
				...
				data: {
					C0123456789101: {
						imgurl: '../addons/we7_wmall/plugin/iservice/static/img/default/banner-1.jpg?t=1',
						linkurl: '',
					},
					C0123456789102: {
						imgurl: '../addons/we7_wmall/plugin/iservice/static/img/default/banner-2.jpg',
						linkurl: '',
					}
				}
			},
			picture: {
				...
				data: {
					C0123456789101: {
						imgurl: '../addons/we7_wmall/plugin/iservice/static/img/default/picture-1.jpg',
						linkurl: '',
					},
					C0123456789102: {
						imgurl: '../addons/we7_wmall/plugin/iservice/static/img/default/picture-2.jpg',
						linkurl: '',
					}
				},
			},
			...
			picturew: {
				...
				data: {
					C0123456789101: {
						imgurl: '../addons/we7_wmall/plugin/iservice/static/img/default/cube-1.jpg',
						linkurl: '',
					},
					C0123456789102: {
						imgurl: '../addons/we7_wmall/plugin/iservice/static/img/default/cube-2.jpg',
						linkurl: '',
					},
					C0123456789103: {
						imgurl: '../addons/we7_wmall/plugin/iservice/static/img/default/cube-1.jpg',
			...
			navs: {
				...
				data: {
					C0123456789101: {
						imgurl: '../addons/we7_wmall/plugin/iservice/static/img/default/navs-1.png',
						linkurl: '',
						text: '导航文字1',
						color: '#666666',
					},
					C0123456789102: {
						imgurl: '../addons/we7_wmall/plugin/iservice/static/img/default/navs-2.png',
						linkurl: '',
						text: '导航文字2',
						color: '#666666',
					},
					C0123456789103: {
						imgurl: '../addons/we7_wmall/plugin/iservice/static/img/default/navs-3.png',
						linkurl: '',
						text: '导航文字3',
						color: '#666666',
					},
					C0123456789104: {
						imgurl: '../addons/we7_wmall/plugin/iservice/static/img/default/navs-4.png',
						linkurl: '',
						text: '导航文字4',
						color: '#666666',
					}
			...
			copyright: {
				name: '版权',
				params: {content: '请填写版权说明', imgurl: '../addons/we7_wmall/plugin/iservice/static/img/default/copyright.png'},
				style: {
					showimg: 1,
					style: 1,
					color: '#CECECE',
		...
		$(".btn-save").unbind('click').click(function() {
			...
			irequire(['tiny'], function(tiny){
				if(diy.type == 3) {
					...
					$.post(tiny.getUrl('iservice/diypage/post'), {id: diy.id, data: diy.data}, function(ret) {
						var ret = ret.message;
						if(ret.errno != 0) {
							Notify.error(ret.message);
