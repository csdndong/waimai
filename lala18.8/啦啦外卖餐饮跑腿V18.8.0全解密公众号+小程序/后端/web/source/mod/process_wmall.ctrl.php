<?php
define('MOD_WMALL', 'we7_wmall');
require IA_ROOT . '/addons/we7_wmall/version.php';
load()->func('communication');
load()->model('mod_wmall');
...
setting_upgrade_version_wmall('{$packet['family']}', '{$script['version']}', '{$script['release']}');
return true;
DAT;
				}
	...
	if (is_error($packet)) {
		...
		itoast('更新已完成. ', url('mod/mod_wmall'), 'success');
	}
}
template('mod/process_wmall');