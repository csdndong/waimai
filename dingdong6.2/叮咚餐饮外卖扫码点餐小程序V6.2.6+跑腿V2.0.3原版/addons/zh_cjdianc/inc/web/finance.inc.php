...
$wrz_money=number_format($list3['total_money']+$list3['hb_money']+$drzyycost['total_money']-(($list4['poundage']/100*($list3['total_money']+$list3['hb_money']-$list3['ps_money'])+($sys['ps_poundage']/100*$item['ps_money'])+($drzyycost['total_money']*$list4['yd_poundage']/100))),2,".","");
