...
$total=pdo_fetchcolumn("select count(*) from " . tablename("account_wxapp") . " a"  . " left join " . tablename("wxapp_versions") . " b on b.uniacid=a.uniacid WHERE b.modules LIKE '%{$_GPC['m']}%' and  name LIKE :name  group by a.uniacid",array(':name'=>$where));
