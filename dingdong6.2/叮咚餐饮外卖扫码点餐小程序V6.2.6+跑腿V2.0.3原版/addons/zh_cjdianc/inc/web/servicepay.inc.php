...
$certfile = IA_ROOT . "/addons/zh_cjdianc/cert/" . 'apiclient_cert_service' . $_W['uniacid'] . '.pem';
$keyfile = IA_ROOT . "/addons/zh_cjdianc/cert/" . 'apiclient_key_service' . $_W['uniacid'] . '.pem';
