...
Page({
    ...
    tzweb: function(t) {
        ...
        var e = this.data.lblist[t.currentTarget.dataset.index],
            a = t.currentTarget.dataset.sjtype;
    ...
    formSubmit: function(t) {
        ...
        var e = t.detail.value.name,
            a = t.detail.value.tel,
            n = t.detail.value.checkbox.length,
        ...
        var c = "",
            l = !0;
        "" == e ? c = "请填写姓名！" : "" == a ? c = "请填写联系电话！" : 11 != a.length ? c = "手机号错误！" : 0 == n ? c = "阅读并同意《申请分销商协议》" : (l = !1, wx.showLoading({
            title: "加载中...",
            mask: !0
        }), app.util.request({
