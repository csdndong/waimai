    ...
    reLoad: function() {
        ...
        console.log(t, e, i, n, a), app.util.request({
            ...
            success: function(t) {
                ...
                for (var e = 0; e < t.data.length; e++) t.data[e].time = util.ormatDate(t.data[e].time), t.data[e].xf_time = util.ormatDate(t.data[e].xf_time);
