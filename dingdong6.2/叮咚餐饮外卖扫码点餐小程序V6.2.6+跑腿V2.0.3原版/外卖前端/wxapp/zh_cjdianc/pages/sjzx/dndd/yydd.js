...
Page((_defineProperty(_Page = {
    ...
    xztype: function(t) {
        ...
        console.log(a), 0 == a && (e = ""), 1 == a && (e = "2"), 2 == a && (e = "3"), 3 == a && (e = "4"), this.setData({
    ...
    reLoad: function() {
        var s = this,
            ...
            d = this.data.end_time;
        console.log(t, e, i, n, a, o, d), app.util.request({
            url: "entry/wxapp/storeYyOrder",
            cachetime: "0",
            data: {
                yy_state: e,
                keywords: a,
...
}), _defineProperty(_Page, "jjjd", function(t) {
    var e = this,
        a = t.currentTarget.dataset.id,
        s = t.currentTarget.dataset.type;
    console.log(a, s), wx.showModal({
        title: "提示",
        content: "4" == s ? "是否拒绝订单？" : "是否确认订单？",
        cancelText: "否",
        confirmText: "是",
        success: function(t) {
