...
Page({
    ...
    xztype: function(t) {
        ...
        console.log(a), 0 == a && (e = "1"), 1 == a && (e = "2"), 2 == a && (e = "3"), 3 == a && (e = "4"), this.setData({
    ...
    reLoad: function() {
        var t, a = this,
            ...
            r = this.data.end_time;
        1 == s && (t = "1,2,3"), 2 == s && (t = "1"), 3 == s && (t = "2"), 4 == s && (t = "3"), console.log(s, t, i, o, r, n, d, e), app.util.request({
