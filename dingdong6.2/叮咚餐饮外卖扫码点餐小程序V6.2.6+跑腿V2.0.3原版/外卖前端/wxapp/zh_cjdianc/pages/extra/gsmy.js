...
Page({
    ...
    onLoad: function(t) {
        ...
        console.log(e), a.util.request({
            ...
            success: function(t) {
                console.log(t);
                for (var e = [], a = [], n = 0; n < t.data.length; n++) 3 == t.data[n].type && e.push(t.data[n]), 4 == t.data[n].type && a.push(t.data[n]);
                o.setData({
                    dbllz: e,
                    zbllz: a
                })
            ...
            success: function(t) {
                console.log(t.model), console.log(t.pixelRatio), console.log(t.windowWidth), console.log(t.windowHeight), console.log(t.language), console.log(t.version), console.log(t.platform), "android" != t.platform && o.setData({
                    top: "-330"
                })
            }
        })
    ...
    onShow: function() {
        ...
        console.log(n.toString()), a.util.request({
            ...
            success: function(t) {
                console.log(t), "" != t.data.dq_time && t.data.dq_time >= n.toString() && (t.data.ishy = 1), e.setData({
                    userInfo: t.data
                })
            }
        })
