...
Page({
    ...
    formSubmit: function(a) {
        ...
        var T = wx.getStorageSync("users").openid,
            q = "";
        "" == o ? q = "请输入商户名称" : null == _ ? q = "请选择商户地址" : "" == s ? q = "请输入商户简介" : "" == n ? q = "请输入联系人姓名" : "" == i ? q = "请输入联系人电话" : null == h ? q = "请上传商户logo" : null == y ? q = "请上传身份证正面照片" : null == w ? q = "请上传身份证反面照片" : null == x ? q = "请上传营业执照" : c != l && 1 == z ? q = "验证码输入错误" : 0 == u ? q = "请先阅读并同意入驻申请协议" : 0 == p && (q = "请选择入驻期限"), 1 == app.title(q) && app.util.request({
