...
Page({
    ...
    commentSubmit: function(t) {
        var o = wx.getStorageSync("users").id,
            ...
            a = this.data.orderinfo.order.id,
            n = this.data.pjnr,
            s = this.data.count,
            i = this.data.images;
        if (console.log(a, o, e, n, s, i), 0 == s) wx.showModal({
            ...
            wx.showLoading({
                ...
                wx.uploadFile({
                    ...
                    complete: function() {
                        console.log(e), ++e == o.path.length ? (wx.hideToast(), console.log("执行完毕"), c(), console.log("成功：" + a + " 失败：" + n)) : (console.log(e), o.i = e, o.success = a, o.fail = n, t(o))
                    }
                })
            }({
