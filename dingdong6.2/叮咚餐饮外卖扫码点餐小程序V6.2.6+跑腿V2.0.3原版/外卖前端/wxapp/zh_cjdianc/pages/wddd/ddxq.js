...
Page({
    ...
    countdown: function(o) {
        var a = this,
            t = (o || []) - Math.round((new Date).getTime() / 1e3) || [];
        a.setData({
    ...
    dateformat: function(o) {
        var a = Math.floor(o),
            t = Math.floor(a / 3600 / 24),
            e = Math.floor(a / 3600 % 24),
            n = Math.floor(a / 60 % 60),
            r = Math.floor(a % 60);
        return t < 10 && (t = "0" + t), e < 10 && (e = "0" + e), r < 10 && (r = "0" + r), n < 10 && (n = "0" + n), {
            day: t,
            hr: e,
            min: n,
            sec: r
    ...
    location: function() {
        var o = this.data.odinfo.store.coordinates.split(","),
            a = this.data.odinfo.store;
