...
Page({
    ...
    radioChange: function(t) {
        ...
        for (var e = this.data.radioItems, a = 0, o = e.length; a < o; ++a) e[a].checked = e[a].id == t.detail.value, e[a].checked && this.setData({
            zfmoney: e[a].money,
            month: e[a].days
        });
        this.setData({
    ...
    formSubmit: function(a) {
        var o = this,
            i = a.detail.formId,
            n = this.data.userInfo.openid,
            t = this.data.userInfo.id,
            l = Number(this.data.zfmoney),
            e = this.data.month,
            s = this.data.lxr,
            d = this.data.tel;
        if (console.log(n, t, l, i, e, s, d), "yezf" == a.detail.value.radiogroup) {
            var r = Number(this.data.userInfo.wallet),
                u = l;
