...
Page({
    ...
    onLoad: function(t) {
        ...
        app.util.request({
            ...
            success: function(t) {
                console.log(t);
                var e = t.data;
                "2" == e.model && (getApp().sjid = e.default_store), "4" == e.model && (getApp().sjid = e.default_store), "" == t.data.dc_name && (t.data.dc_name = "店内"), "" == t.data.wm_name && (t.data.wm_name = "外卖"), "" == t.data.yd_name && (t.data.yd_name = "预定"), a.setData({
                    System: t.data
                })
            }
        });
    ...
    reLoad: function() {
        var t, o = this,
            ...
            s = this.data.pagenum;
        1 == e && (t = "2"), 2 == e && (t = "3"), 3 == e && (t = "4"), console.log(t, a, s), app.util.request({
    ...
    orderPay: function(t) {
        var e = getApp().getOpenId,
            ...
            s = t.currentTarget.dataset.money,
