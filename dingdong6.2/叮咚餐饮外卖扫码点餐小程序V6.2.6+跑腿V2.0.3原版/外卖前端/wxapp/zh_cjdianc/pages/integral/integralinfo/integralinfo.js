...
Page({
    ...
    formSubmit: function(t) {
        ...
        var e = this,
            ...
            c = (e.data.ssq, e.data.ssq + t.detail.value.grxxdz);
        console.log(a, o, s, d, l, c, n, i);
        var u = "",
            r = !0;
        "" == d ? u = "请填写联系人！" : "" == l ? u = "请填写联系电话！" : /^0?(13[0-9]|15[012356789]|17[013678]|18[0-9]|14[57])[0-9]{8}$/.test(l) && 11 == l.length ? "" == c ? u = "请选择位置！" : (r = !1, e.setData({
            qddh: !0
        }), app.util.request({
            url: "entry/wxapp/Exchange",
            cachetime: "0",
