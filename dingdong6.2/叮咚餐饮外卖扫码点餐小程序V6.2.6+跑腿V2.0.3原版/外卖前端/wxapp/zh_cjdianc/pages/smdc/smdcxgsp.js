...
Page({
    ...
    spxqck: function(t) {
        var a = t.currentTarget.dataset.itemIndex,
            ...
            d = this.data.dishes[e].good[a],
            r = wx.getStorageSync("users").id,
            n = this.data.store_id;
            ...
            success: function(n) {
                console.log(n.data), getApp().imgurl = n.data, c.setData({
                    ...
                    success: function(t) {
                        ...
                        console.log("当前的系统时间为" + l), console.log("商家的营业时间从" + a + "至" + e, o + "至" + s), 1 == i ? (c.setData({
                            yysjtoggle: !1
                        }), console.log("商家正在休息" + i)) : console.log("商家正在营业" + i), a < s ? a < l && l < e || o < l && l < s ? (console.log("商家正常营业"), c.setData({
                            time: 1
                            ...
                            time: 3,
                            yysjtoggle: !1
                        })) : s < a && (a < l && l < e || o < l && s < l || l < o && l < s ? (console.log("商家正常营业"), c.setData({
                            time: 1
                        })) : l < a || e < l && l < o ? (console.log("商家还没开店呐，稍等一会儿可以吗？"), c.setData({
                            time: 2,
                            yysjtoggle: !1
