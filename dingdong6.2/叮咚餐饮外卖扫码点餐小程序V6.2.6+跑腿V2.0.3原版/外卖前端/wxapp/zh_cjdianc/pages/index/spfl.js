...
Page({
    ...
    onTapTag: function(t) {
        ...
        "1" == t.currentTarget.dataset.index && (e.by = "juli asc"), "2" == t.currentTarget.dataset.index && (e.by = "sales desc"), console.log(e, t.currentTarget.dataset.index), this.setData({
    ...
    sortSelected: function(t) {
        var e = this.data.params;
        "0" == t.currentTarget.dataset.sortindex && (e.by = "number asc"), "1" == t.currentTarget.dataset.sortindex && (e.by = "score desc"), "2" == t.currentTarget.dataset.sortindex && (e.by = "start_at asc"), "3" == t.currentTarget.dataset.sortindex && (e.by = "ps_money asc"), console.log(e, t.currentTarget.dataset.index, t.currentTarget.dataset.sortindex + 1), this.setData({
            selected: t.currentTarget.dataset.index,
    ...
    finish: function() {
        var t = this.data.params,
            e = this.data.characteristicSelected,
            a = this.data.characteristicList,
            s = this.data.discountSelected;
        this.setData({
            issx: !0
        });
        for (var n = 0; n < e.length; n++) e[n] && ("0配送费" == a[n].text && (t.nopsf = 1), "0元起送" == a[n].text && (t.nostart = 1));
    ...
    getstorelist: function() {
        var n = this,
            i = n.data.pagenum;
        n.data.params.page = i, n.data.params.pagesize = 10, console.log(i, n.data.params), n.setData({
            isjzz: !0
        }), a.util.request({
            ...
            success: function(t) {
                ...
                for (var a = 0; a < t.data.length; a++) {
                    ...
                    console.log(s), console.log(), t.data[a].aa = s < 1e3 ? s + "m" : (s / 1e3).toFixed(2) + "km", t.data[a].aa1 = s, n.setData({
                        storelist: e,
                        bfstorelist: e
                    })
                }
