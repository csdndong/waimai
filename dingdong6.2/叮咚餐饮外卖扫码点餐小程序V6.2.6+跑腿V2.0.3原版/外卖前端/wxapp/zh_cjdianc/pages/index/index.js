...
Page({
    ...
    onTapTag: function(t) {
        ...
        "1" == t.currentTarget.dataset.index && (a.by = "juli asc"), "2" == t.currentTarget.dataset.index && (a.by = "sales desc"), console.log(a, t.currentTarget.dataset.index), this.setData({
    ...
    sortSelected: function(t) {
        var a = this.data.params;
        "0" == t.currentTarget.dataset.sortindex && (a.by = "number asc"), "1" == t.currentTarget.dataset.sortindex && (a.by = "score desc"), "2" == t.currentTarget.dataset.sortindex && (a.by = "start_at asc"), "3" == t.currentTarget.dataset.sortindex && (a.by = "ps_money asc"), console.log(a, t.currentTarget.dataset.index, t.currentTarget.dataset.sortindex + 1), this.setData({
            selected: t.currentTarget.dataset.index,
    ...
    finish: function() {
        var t = this.data.params,
            a = this.data.characteristicSelected,
            e = this.data.characteristicList,
            s = this.data.discountSelected;
        this.setData({
            issx: !0
        });
        for (var n = 0; n < a.length; n++) a[n] && ("0配送费" == e[n].text && (t.nopsf = 1), "0元起送" == e[n].text && (t.nostart = 1));
    ...
    dwreLoad: function() {
        ...
        wx.getLocation({
            ...
            success: function(t) {
                var e = t.latitude,
                    s = t.longitude;
                i.lat = e, i.lng = s, n.setData({
                    params: i
                }), n.getstorelist(), a.util.request({
    ...
    getstorelist: function() {
        var c = this,
            l = c.data.pagenum;
        c.data.params.page = l, c.data.params.pagesize = 10, console.log(l, c.data.params), c.setData({
            isjzz: !0
        }), a.util.request({
            ...
            success: function(t) {
                ...
                for (var a = 0, e = t.data.length; a < e; a++) {
                    ...
                    t.data[a].aa = s < 1e3 ? s + "m" : (s / 1e3).toFixed(2) + "km", t.data[a].aa1 = s
                }
                var n = c.data.bfstorelist;
                if (n = n.concat(t.data), 1 == c.data.mdxx.isyykg) {
                    for (var i = [], o = [], r = 0, d = n.length; r < d; r++) 2 == n[r].is_yy ? o.push(n[r]) : i.push(n[r]);
                    n = i.concat(o)
                }
                n = function(t) {
                    for (var a = [], e = 0, s = t.length; e < s; e++) - 1 == a.indexOf(t[e]) && a.push(t[e]);
                    return a
                }(n), c.setData({
                    isxlsxz: !1,
                    storelist: n,
    ...
    tzsjxq: function(t) {
        console.log(t.currentTarget.dataset, this.data.mdxx), 1 == t.currentTarget.dataset.type ? (getApp().sjid = t.currentTarget.dataset.sjid, wx.navigateTo({
            url: "/zh_cjdianc/pages/seller/index"
        })) : "1" == this.data.mdxx.is_tzms ? (getApp().sjid = t.currentTarget.dataset.sjid, wx.navigateTo({
            url: "/zh_cjdianc/pages/seller/index"
        })) : wx.navigateTo({
        ...
        o.setData({
            ...
            console.log(s), a.util.request({
                ...
                success: function(t) {
                    ...
                    console.log(t.data, e), e >= t.data.time && e < t.data.time2 ? (console.log("hbtime"), "1" == t.data.is_tjhb && a.util.request({
                        ...
                        success: function(t) {
                            console.log(t.data, _typeof(t.data)), t.data, t.data, "object" == _typeof(t.data) && (console.log(_typeof(t.data)), o.setData({
                                istjhb: !0,
                                tjhbarr: t.data
                            }), o.refresh())
                        }
            ...
            success: function(t) {
                ...
                }), o.dwreLoad(), wx.setStorageSync("bqxx", t.data)
            }
        }), a.util.request({
            url: "entry/wxapp/Llz",
            cachetime: "0",
            ...
            success: function(t) {
                console.log(t);
                for (var a = [], e = [], s = 0; s < t.data.length; s++) 1 == t.data[s].type && a.push(t.data[s]), 2 == t.data[s].type && e.push(t.data[s]);
                o.setData({
                    dbllz: a,
                    zbllz: e
                })
            ...
            success: function(t) {
                console.log(t);
                for (var a = [], e = [], s = [], n = [], i = 0; i < t.data.length; i++) "1" == t.data[i].type ? a.push(t.data[i]) : "3" == t.data[i].type ? e.push(t.data[i]) : "4" == t.data[i].type ? s.push(t.data[i]) : "11" == t.data[i].type && n.push(t.data[i]);
                o.setData({
                    toplb: a,
                    zblb: e,
                    dblb: s,
