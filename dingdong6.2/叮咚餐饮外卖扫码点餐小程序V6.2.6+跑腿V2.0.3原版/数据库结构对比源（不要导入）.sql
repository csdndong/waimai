...
Date: 2019-08-09 13:09:33
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for ims_cjdc_account
-- ----------------------------
...
-- ----------------------------
-- Table structure for ims_cjdc_service_pay
-- ----------------------------
DROP TABLE IF EXISTS `ims_cjdc_service_pay`;
CREATE TABLE `ims_cjdc_service_pay` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
